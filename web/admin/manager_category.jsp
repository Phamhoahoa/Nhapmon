...
<h3>QUẢN LÝ DANH MỤC</h3>
                    ...
                    <a href="/RESTAURANT-BTL/admin/insert_category.jsp">Thêm danh mục</a>
                    <table class="data">
                        <tr class="data">
                        ...
                        <center>
                            <a href="${root}/admin/update_category.jsp?admin/ommand=update&category_id=<%=category.getCategoryID()%>">Sửa</a>&nbsp;&nbsp; | &nbsp;&nbsp;
                                <a href="${root}/ManagerCategory?command=delete&category_id=<%=category.getCategoryID()%>">Xóa</a>
                        </center>
                        </td>
                        </tr>
                        <% } %>
