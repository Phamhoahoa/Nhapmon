        ...
        <jsp:include page="header.jsp"></jsp:include>
            ...
            <jsp:include page="menu.jsp"></jsp:include>
                ...
                <div id="rightContent">
                    ...
                    <form action="${root}/ManagerCategory" method="post">
                    <table width="95%">
                        <tr>
                            <td style="float: right"><b>Tên danh mục:</b></td>
                            <td><input type="text" class="sedang" name="category_name" value="<%=category.getCategoryName()%>"><%=error%></td>
                        </tr>
                        <tr>
                            <td style="float: right"><b>Mã danh mục:</b></td>
                            <td><input type="text" class="sedang" name="category_id" value="<%=category.getCategoryID()%>"><%=error%></td>
                        </tr>
                        <tr><td></td><td>
